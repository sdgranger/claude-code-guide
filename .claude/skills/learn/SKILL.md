...
4. AskUserQuestion으로 궁금한 점이 있는지 먼저 물어봅니다. 질문이 있으면 답변 후 다시 질문 기회를 줍니다.
5. 궁금한 점이 없으면 AskUserQuestion으로 이해를 확인하는 퀴즈를 냅니다.
6. 정답이면 체크하고 다음으로 넘어갑니다. 오답이면 다시 설명합니다.

**설정/작성 항목** (예: `프로젝트용 CLAUDE.md 작성`):
1. 무엇을 해야 하는지 설명합니다.
2. 구체적인 예시와 템플릿을 제시합니다.
3. AskUserQuestion으로 궁금한 점이 있는지 먼저 물어봅니다. 질문이 있으면 답변 후 다시 질문 기회를 줍니다.
4. AskUserQuestion으로 직접 해보았는지 확인합니다.
5. 완료 확인 후 체크합니다.
